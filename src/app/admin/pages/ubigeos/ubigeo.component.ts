...
export class UbigeoComponent implements OnInit {
    ...
    ngOnInit() {
        this.ubigeoService.getUbigeoChange().subscribe((data) => {
            this.getPage(
                this.currentPage,
                this.rows,
                this.sortField,
        ...
        this.ubigeoService.getMessageChange().subscribe((data) => {
    ...
    getPage(
        ...
        this.ubigeoService
            ...
            .subscribe((res) => {
                this.ubigeos = res.content;
                this.totalRecords = res.totalElements;
                this.loading = false;
            });
    }
    new() {
        this.ref = this.dialogService.open(UbigeoFormComponent, {
            header: 'Nuevo Ubigeo',
            width: '550px',
    ...
    edit(Ubigeo: Ubigeo) {
        this.ubigeoService.findById(Ubigeo.idUbigeo).subscribe((data) => {
            this.ref = this.dialogService.open(UbigeoFormComponent, {
                header: 'Editar Ubigeo',
                width: '550px',
                contentStyle: { overflow: 'auto' },
                baseZIndex: 10000,
                maximizable: true,
    ...
    confirmDelete() {
        ...
        this.ubigeoService.delete(this.ubigeo.idUbigeo).subscribe((resp) => {
