...
export class SectorComponent implements OnInit {
    ...
    ngOnInit() {
        this.sectorService.getSectorChange().subscribe((data) => {
            this.getPage(
                this.currentPage,
                this.rows,
                this.sortField,
        ...
        this.sectorService.getMessageChange().subscribe((data) => {
    ...
    loadSectores(event: any) {
        this.rows = event.rows;
        this.sortField = event.sortField;

        if (this.sortField == undefined) {
            this.sortField = 'nombreSector';
        }
    ...
    confirmDelete() {
        ...
        this.sectorService.delete(this.sector.idSector).subscribe((resp) => {
