...
export class ProductoComponent implements OnInit {
    ...
    edit(producto: Producto) {
        this.productoService.findById(producto.idProducto).subscribe((data) => {
            console.log(data);
            this.ref = this.dialogService.open(ProductoFormComponent, {
    ...
    confirmDelete() {
        ...
        this.productoService.delete(this.producto.idProducto).subscribe((resp) => {
